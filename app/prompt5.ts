...
- ให้ Main.gs เป็นไฟล์เดียวที่ประกาศ onOpen และสร้างเมนู “WEUP SoloSix”
...
- ฟังก์ชันทุกตัวที่ Dashboard.html เรียกต้องประกาศอยู่ใน Main.gs ชื่อไฟล์ HTML ต้องเป็น Dashboard เพื่อให้ตรงกับ createHtmlOutputFromFile('Dashboard') และต้องมี doGet สำหรับเผยแพร่เป็น Web App

การเชื่อมต่อ AI:
- อ่าน API key จาก PropertiesService.getScriptProperties() ด้วยชื่อ API_KEY เท่านั้น ห้ามเขียนคีย์ลงในโค้ดหรือชีต
- อ่าน AI_PROVIDER จาก CONFIG และรองรับ OPENAI กับ ANTHROPIC อ่านชื่อโมเดลจาก AI_MODEL และจำนวนโทเค็นจาก MAX_TOKENS โดยกำหนดค่าเริ่มต้นไม่น้อยกว่า 4000
...
1. setupSystem สร้างชีต คอลัมน์ รายการแบบเลือก สูตร และค่ากำหนดโดยไม่ลบข้อมูลที่มีอยู่
